...
export function ReceptionStep({ problem, setProblem, onSubmit, isLoading }: ReceptionStepProps) {
  return (
    <MotionContainer key="reception" className="space-y-8">
      <Card>
        <label htmlFor="problem" className="block text-xl font-medium mb-4 text-stone-800">
